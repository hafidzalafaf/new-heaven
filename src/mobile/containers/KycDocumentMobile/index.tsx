...
import { CustomInput, UploadFile, SearchDropdown } from 'src/desktop/components';
                    ...
                    <div className="container">
                        <div className="kyc-document-screen">
                            <div>
                                ...
                                {kycStatus !== 'pending' && (
                                    <>
                                        <h6 className="text-white mb-3">Profile ID Verification</h6>
                                    </>
                                )}
                            </div>
                                            ...
                                            {this.state.step == 'document' && (
                                                <React.Fragment>
                                                    ...
                                                    <div className="row gap-5">
                                                        <div className="col-lg-6 mb-5 upload-file-kyc">
                                                            <UploadFile
                                                                ...
                                                                uploadedFile={
                                                                    fileFront[0] && (fileFront[0] as File).name
                                                                }
                                                                fileSizeErrorMessage={frontFileSizeErrorMessage}
                                                            />
                                                        </div>
                                                        <div className="col-lg-6 pt-3 mt-5 mb-5">
                                                            <UploadFile
                                                                isMobileDevice={isMobileDevice}
                                                                id="fileSelfie"
                                                                title={this.translate(
                                                    ...
                                                    <div className="mt-5 mb-2 gap-3 pt-4">
                                                        <button
                                                            type="button"
                                        ...
                                        <div className="py-5">
                                            <div className="d-flex align-items-center flex-column">
                                                ...
                                                <p className="text-sm text-center grey-text-accent">
                                                    We will complete the verification within 1 to 3 business days and
                                                    notify the result to you through SMS and email. <br /> To ensure
                                                    your account security, the withdrawal services on KuCoin and Futures
                                                    will be temporarily closed for 24 hours after the setting is
                                                    approved.
                                                </p>
                                            </div>
                                        </div>
