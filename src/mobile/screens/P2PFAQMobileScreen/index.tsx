        ...
        return (
            <section className="d-flex flex-row align-items-center justify-content-around">
                <div
                    ...
                    className="arrow-container rounded">
                ...
                <div
                    onClick={currentPage < 4 ? () => setCurrentPage(currentPage + 1) : null}
                    className="arrow-container rounded">
    ...
    return (
        <section className="pg-mobile-screen-p2p mobile-container">
            ...
            <div className="d-flex flex-column justify-content-between">
                ...
                <span className="grey-text-accent text-xs">
                    P2P platform allows user to buy or sell crypto directly from other users
                </span>
                {currentPage === 1 ? (
                    <img src="/img/MobileP2PHelpPlaceHolder-1.png" alt="placeholder" className="img-placeholder" />
                ) : currentPage === 2 ? (
                    <img src="/img/MobileP2PHelpPlaceHolder-2.png" alt="placeholder" className="img-placeholder" />
                ) : currentPage === 3 ? (
                    <img src="/img/MobileP2PHelpPlaceHolder-3.png" alt="placeholder" className="img-placeholder" />
                ) : (
                    <img src="/img/MobileP2PHelpPlaceHolder-4.png" alt="placeholder" className="img-placeholder" />
                )}
            </div>
            <P2PHelpPagination />
        </section>
