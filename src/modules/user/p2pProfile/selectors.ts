...
export const selectP2PProfileChangeUsernameLoading = (state: RootState): boolean => state.user.p2pProfile.changeUsername.fetching;

export const selectP2PProfileChangeUsernameSuccess = (state: RootState): boolean => state.user.p2pProfile.changeUsername.success;

export const selectP2PProfileChangeUsernameError = (state: RootState): CommonError | undefined => state.user.p2pProfile.changeUsername.error;