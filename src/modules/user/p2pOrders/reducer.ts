...
export const initialOrderState: P2POrdersState = {
    create: {
        data: {},
        fetching: false,
        success: false,
...
export const orderFetchReducer = (state: P2POrdersState['fetch'], action: OrderActions) => {
    switch (action.type) {
        case ORDER_FETCH:
            return {
                ...state,
...
export const orderDetailReducer = (state: P2POrdersState['detail'], action: OrderActions) => {
    switch (action.type) {
...
const orderCreateReducer = (state: P2POrdersState['create'], action: OrderActions) => {
    switch (action.type) {
        case ORDER_CREATE:
            return {
                ...state,
...
const orderCancelReducer = (state: P2POrdersState['cancel'], action: OrderActions) => {
    switch (action.type) {
        case ORDER_CANCEL:
            return {
                ...state,
...
const orderConfirmSellReducer = (state: P2POrdersState['order_confirm_sell'], action: OrderActions) => {
    switch (action.type) {
...
const orderConfirmPaymentReducer = (state: P2POrdersState['payment_confirm'], action: OrderActions) => {
    switch (action.type) {
...
export const orderChatReducer = (state: P2POrdersState['chat'], action: OrderActions) => {
    switch (action.type) {
        case ORDER_CHAT:
            return {
                ...state,
...
const orderChatCreateReducer = (state: P2POrdersState['chat_create'], action: OrderActions) => {
    switch (action.type) {
...
export const orderReportReducer = (state: P2POrdersState['report'], action: OrderActions) => {
    switch (action.type) {
        case ORDER_REPORT:
            return {
                ...state,
...
const orderReportCreateReducer = (state: P2POrdersState['report_create'], action: OrderActions) => {
    switch (action.type) {
...
export const p2pOrdersReducer = (state = initialOrderState, action: OrderActions) => {
    switch (action.type) {
        case ORDER_FETCH:
        case ORDER_DATA:
        case ORDER_ERROR:
