...
export const ru: LangType = {
    ...
    'page.header.navbar.help': 'Помощь',
    'page.header.navbar.order': 'Заказ',
    ...
    'success.beneficiaries.created': 'Пожалуйста, активируйте адрес получателя',
    ...
    'page.body.kyc.documents.uploadFile.front.title': 'Загрузите лицевую сторону удостоверения личности',
    ...
    'page.body.kyc.documents.uploadFile.selfie.title': 'Загрузите свое селфи с удостоверением личности',
    ...
    'identity.user.utilized_token': 'Неверный код, попробуйте еще раз',
