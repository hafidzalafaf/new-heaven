...
export const en = {
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.body.kyc.documents.uploadFile.front.title': 'Upload Your Front of ID Card',
    ...
    'page.body.kyc.documents.uploadFile.selfie.title': 'Upload Your Selfie With ID Card',
    ...
    'page.password2fa.message': 'Please enter 6 Digits authentication code from your App',
    ...
    'identity.user.utilized_token': 'Code incorrect, please try again',
    ...
    'authz.client_session_mismatch': 'Login session has expired',
